...
namespace WinUpdateHelper
{
    internal static class UpdateManager
    {
        public static void UninstallUpdate(string updateId)
        {
            ...
            var wuaSession = (IUpdateSession)new UpdateSession();
            ...
            var updates = wuaSearch.Updates.Cast<IUpdate>().ToList();
    ...
    [InterfaceType(ComInterfaceType.InterfaceIsIDispatch)]
    public interface IUpdateCollection : System.Collections.IEnumerable
    {
        [DispId(0)]
