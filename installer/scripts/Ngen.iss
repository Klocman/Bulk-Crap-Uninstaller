...
sl.NgenOptimizing =Optimizacija delovanje vašega sistema ...     
nl.NgenOptimizing =Optimaliseren prestaties voor uw systeem ...
es.NgenOptimizing =Optimización del rendimiento de su sistema ...
...
es.NgenRemoving =Eliminación de datos en caché ...
