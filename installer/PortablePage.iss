...
uk.InstallStandardInfo =Цей варіант встановить BCUninstaller на ваш комп'ютер як звичайний застосунок. Буде створено стандартний засіб видалення, який відображатиметься в розділі "Програми та компоненти", а також в інших сторонніх засобах видалення.
